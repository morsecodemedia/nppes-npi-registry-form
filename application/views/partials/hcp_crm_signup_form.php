    ...
    <div class="row">
      <div class="small-12 columns">        
        <label for="product_opt_in">
          <input type="checkbox" name="" id="" class="" value="1" /> Yes, I would like to receive information in the future about {{Drug Name}} and related health information.
        </label>
        <label for="corporate_opt_in">
          <input type="checkbox" name="" id="" class="" value="1" /> Yes, I would like to receive information in the future about TayKrog Pharmaceuticals and the brands they manage.
        </label>
        <p><small>TayKrog Pharmaceuticals understands that your privacy is important. Please note that by providing your name, address, or other information, you are giving TayKrog and companies working with us permission to communicate with you via traditional mail, email, telephone, or text about {{Drug NAME}} and other TayKrog products, programs, and services. We will not sell or transfer your name, address, or other personally identifiable information about you to any party for its own marketing use. To view the privacy policy, please visit <a href="" class="track-click" data-action="click" data-category="exit" data-value="" data-label="">www.taykrog.com/privacy-legal</a>.</small></p>
      </div>
    </div>
